...
skills/*/SKILL.md (sync, backlog, close, inbox) — выполняй их по шагам, когда
...
- [Навыки](docs/skills.md) — sync / backlog / close / inbox, как добавить свой, использование в любом агенте
